...
public class TMazeExample {
    ...
    public static void main(String[] args) {
        ...
        Builder<Environment<IntegerAction>> environmentBuilder = () -> new TMaze(TMAZE_LENGTH, rnd);
        ...
        try {
			network.saveTo(new File( System.getProperty("user.home") + "/" + Constants.DATA_DIR + "/examples/tmaze.training"), false);
		} catch (IOException e) {
    ...
    private static class EpisodeScorePrinter implements AgentListener<Observation, IntegerAction> {
        ...
        public void onAfterEpisode(SteppingAgent agent) {
            TMaze environment = (TMaze)agent.getEnvironment();
