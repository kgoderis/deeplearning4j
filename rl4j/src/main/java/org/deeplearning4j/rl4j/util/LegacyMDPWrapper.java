...
//import org.deeplearning4j.rl4j.environment.observation.transform.ObservationToINDArrayTransform;
...
//
//
//    public LegacyMDPWrapper(MDP<OBSERVATION, A, AS> wrappedMDP, HistoryProcessor historyProcessor) {
...
//    }
//
//    public void setHistoryProcessor(HistoryProcessor historyProcessor) {
//        this.historyProcessor = historyProcessor;
...
//        HistoryProcessor historyProcessor = getHistoryProcessor();
//
