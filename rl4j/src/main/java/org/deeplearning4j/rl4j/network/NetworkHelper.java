...
public class NetworkHelper {
    ...
    /**
     * Create a {@link NetworkHandler} with explicit network inputs to channel names mapping
     ...
     * @return A {@link NetworkHandler}
     */
    public NetworkHandler buildHandler(ComputationGraph model,
    ...
    /**
     * Create a {@link NetworkHandler} with the single network input mapped to a specific observation channel
     * @param model A {@link ComputationGraph} instance
     ...
     * @return A {@link NetworkHandler}
     */
    public NetworkHandler buildHandler(MultiLayerNetwork model,
                                        String networkInputChannel,
                                        String[] channelNames,
                                        String labelName,
                                        String gradientName) {
