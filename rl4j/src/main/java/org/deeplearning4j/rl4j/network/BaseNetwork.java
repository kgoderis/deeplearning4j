...
public abstract class BaseNetwork<NET extends BaseNetwork>
        implements TrainableNeuralNet<NET> {
    ...
    protected BaseNetwork(NetworkHandler networkHandler) {
