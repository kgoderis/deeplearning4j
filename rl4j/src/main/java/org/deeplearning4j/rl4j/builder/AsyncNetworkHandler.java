...
public class AsyncNetworkHandler implements NetworkHandler {

    @Getter
    final TrainableNeuralNet targetNetwork;

    @Getter
    TrainableNeuralNet threadCurrentNetwork;

    @Getter
    final TrainableNeuralNet globalCurrentNetwork;

    public AsyncNetworkHandler(TrainableNeuralNet network) {
