...
public interface NetworkHandler {
     ...
     */
    TrainableNeuralNet getTargetNetwork();

    /**
     * @return The thread-specific parameters &theta;'
     */
    TrainableNeuralNet getThreadCurrentNetwork();

    /**
     * @return The global shared parameters &theta;
     */
    TrainableNeuralNet getGlobalCurrentNetwork();

    /**
     * Perform the required changes before a new LearningAgent is built
     */
