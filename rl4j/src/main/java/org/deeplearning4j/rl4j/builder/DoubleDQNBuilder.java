...
/**
 * A {@link LearningAgent} builder that will setup a {@link DoubleDQN
 * double-BaseDQN} algorithm in addition to the setup done by
 * {@link BaseDQNAgentLearnerBuilder}.
 */
public class DoubleDQNBuilder<OBSERVATION extends Observation, ACTION extends DiscreteAction>
		extends BaseDQNAgentLearnerBuilder<OBSERVATION, ACTION, DoubleDQNBuilder.Configuration<OBSERVATION, ACTION>> {

	public DoubleDQNBuilder(Configuration<OBSERVATION, ACTION> configuration, TrainableNeuralNet neuralNet,
