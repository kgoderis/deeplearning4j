...
public class RobotLake implements Environment<IntegerAction>  {
    ...
    @Getter
    private IntegerActionSpace space;
...
//    private ObservationSpace<RobotLakeState> observationSpace = new ArrayObservationSpace(new int[] {  });
    ...
    public RobotLake(int size, boolean areStartingPositionsRandom, Random rnd) {
        ...
        this.size = size;
        this.space = new IntegerActionSpace(NUM_ACTIONS, ACTION_LEFT, rnd);
    }
