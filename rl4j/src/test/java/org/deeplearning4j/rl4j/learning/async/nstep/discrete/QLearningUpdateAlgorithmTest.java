...
public class QLearningUpdateAlgorithmTest {
    ...
    public void when_isTerminal_expect_initRewardIs0() {
        ...
        List<ObservationActionReward<Integer>> experience = new ArrayList<ObservationActionReward<Integer>>() {
            {
                add(new ObservationActionReward<Integer>(observation, 0, 0.0, true));
            }
        };
    ...
    public void when_terminalAndNoTargetUpdate_expect_initRewardWithMaxQFromCurrent() {
        ...
        List<ObservationActionReward<Integer>> experience = new ArrayList<ObservationActionReward<Integer>>() {
            {
                add(new ObservationActionReward<Integer>(observation, 0, 0.0, false));
            }
        };
        ...
        List<ObservationActionReward<Integer>> experience = new ArrayList<ObservationActionReward<Integer>>() {
            {
                ...
                add(new ObservationActionReward<Integer>(new Observation(Nd4j.create(new double[] { -2.1, -2.2 }).reshape(1, 2)), 1, 2.0, true));
            }
        };
