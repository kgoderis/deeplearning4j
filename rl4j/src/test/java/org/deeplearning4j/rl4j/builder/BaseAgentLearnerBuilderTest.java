...
public class BaseAgentLearnerBuilderTest {
    ...
    @Mock
    UpdateAlgorithm updateAlgorithmMock;

    @Mock
    NeuralNetUpdater neuralNetUpdaterMock;
    ...
    public void setup() {
        ...
        LearningAgent.Configuration agentLearnerConfiguration = LearningAgent.Configuration.builder().maxEpisodeSteps(200).build();
