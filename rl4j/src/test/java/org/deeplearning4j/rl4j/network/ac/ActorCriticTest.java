...
public class ActorCriticTest {
    ...
    public void testModelLoadSave() throws IOException {
        ActorCriticSeparate acs = new ActorCriticFactorySeparateStdDense(NET_CONF).build(new int[]{7}, 5);
        ...
        ActorCriticCompGraph accg = new ActorCriticFactoryCompGraphStdDense(NET_CONF_CG).build(new int[]{37}, 43);
