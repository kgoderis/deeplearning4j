...
public class MockPolicy implements Policy<Integer> {

    public int playCallCount = 0;
    public List<INDArray> actionInputs = new ArrayList<INDArray>();

    @Override
    public <MockObservation extends Encodable, AS extends ActionSpace<Integer>> double play(MDP<MockObservation, Integer, AS> mdp, HistoryProcessor hp) {
        ++playCallCount;
        return 0;
    }
