...
public class AgentTest {
    ...
    public void when_buildingWithNullEnvironment_expect_exception() {
        try {
            new SteppingAgent(null, null, null, null, null);
    ...
    public void when_buildingWithNullTransformProcess_expect_exception() {
        try {
            new SteppingAgent(environmentMock, null, null, null, null);
            fail("NullPointerException should have been thrown");
        } catch (NullPointerException exception) {
    ...
    public void when_buildingWithNullPolicy_expect_exception() {
        try {
            new SteppingAgent(environmentMock, transformProcessMock, null, null, null);
            fail("NullPointerException should have been thrown");
        } catch (NullPointerException exception) {
    ...
    public void when_buildingWithNullConfiguration_expect_exception() {
        try {
            new SteppingAgent(environmentMock, transformProcessMock, policyMock, null, null);
            fail("NullPointerException should have been thrown");
        } catch (NullPointerException exception) {
    ...
    public void when_buildingWithInvalidMaxSteps_expect_exception() {
        try {
            SteppingAgent.Configuration configuration = SteppingAgent.Configuration.builder()
                .maxEpisodeSteps(0)
                .build();
            new SteppingAgent(environmentMock, transformProcessMock, policyMock, configuration, null);
    ...
    public void when_buildingWithId_expect_idSetInAgent() {
        // Arrange
        SteppingAgent.Configuration configuration = SteppingAgent.Configuration.builder().build();
        SteppingAgent sut = new SteppingAgent(environmentMock, transformProcessMock, policyMock, configuration, "TestAgent");
    ...
    public void when_runIsCalled_expect_agentIsReset() {
        ...
        SteppingAgent.Configuration configuration = SteppingAgent.Configuration.builder().build();
        SteppingAgent sut = new SteppingAgent(environmentMock, transformProcessMock, policyMock, configuration, null);

        when(listenerMock.onBeforeStep(any(SteppingAgent.class), any(Observation.class), anyInt())).thenReturn(AgentListener.ListenerResponse.STOP);
    ...
    public void when_runIsCalled_expect_onBeforeAndAfterEpisodeCalled() {
        ...
        SteppingAgent.Configuration configuration = SteppingAgent.Configuration.builder().build();
        SteppingAgent sut = new SteppingAgent(environmentMock, transformProcessMock, policyMock, configuration, null);
        SteppingAgent spy = Mockito.spy(sut);
    ...
    public void when_onBeforeEpisodeReturnsStop_expect_performStepAndOnAfterEpisodeNotCalled() {
        ...
        when(listenerMock.onBeforeEpisode(any(SteppingAgent.class))).thenReturn(AgentListener.ListenerResponse.STOP);
        sut.addListener(listenerMock);
    ...
    public void when_runIsCalledWithoutMaxStep_expect_agentRunUntilEpisodeIsFinished() {
        ...
        final SteppingAgent spy = Mockito.spy(sut);

        doAnswer(invocation -> {
            ((SteppingAgent)invocation.getMock()).incrementEpisodeStepCount();
            return null;
    ...
    public void when_initialObservationsAreSkipped_expect_performNoOpAction() {
        ...
        when(listenerMock.onBeforeStep(any(SteppingAgent.class), any(Observation.class), any())).thenReturn(AgentListener.ListenerResponse.STOP);
        sut.addListener(listenerMock);
    ...
    public void when_observationsIsSkipped_expect_performLastAction() {
        ...
        ArgumentCaptor<SteppingAgent> agentCaptor = ArgumentCaptor.forClass(SteppingAgent.class);
    ...
    public void when_onAfterStepReturnsStop_expect_onAfterEpisodeNotCalled() {
        ...
        SteppingAgent.Configuration configuration = SteppingAgent.Configuration.builder()
                ...
                .build();
        SteppingAgent sut = new SteppingAgent(environmentMock, transformProcessMock, policyMock, configuration, null);
        when(listenerMock.onAfterStep(any(SteppingAgent.class), any(StepResult.class))).thenReturn(AgentListener.ListenerResponse.STOP);
        sut.addListener(listenerMock);
