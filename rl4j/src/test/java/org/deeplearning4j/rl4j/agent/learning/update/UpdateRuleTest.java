...
public class UpdateRuleTest {
    ...
    @Mock
    private UpdateAlgorithm<FeaturesLabels, Integer> updateAlgorithm;

    @Mock
    private NeuralNetUpdater<FeaturesLabels> updater;

    private DefaultUpdateRule<FeaturesLabels, Integer> sut;

    @BeforeEach
    public void init() {
        sut = new DefaultUpdateRule<FeaturesLabels, Integer>(updateAlgorithm, updater);
    }
